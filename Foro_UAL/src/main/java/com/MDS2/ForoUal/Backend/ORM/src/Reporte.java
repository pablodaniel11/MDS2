...
public class Reporte implements Serializable {
	...
	@Column(name="`IdReporte`", nullable=false, length=10)	
	@Id	
	...
	@JoinColumns(value={ @JoinColumn(name="`MensajeID`", referencedColumnName="`ID`", nullable=false) }, foreignKey=@ForeignKey(name="FKReporte746593"))	
